...
void _locationSerialize(
  ...
  writer.writeBool(offsets[4], object.isDeparture);
...
Location _locationDeserialize(
  ...
  object.id = id;
  object.isDeparture = reader.readBool(offsets[4]);
...
extension LocationQueryWhereSort on QueryBuilder<Location, Location, QWhere> {
  ...
  QueryBuilder<Location, Location, QAfterWhere> anyCreatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension LocationQueryWhere on QueryBuilder<Location, Location, QWhereClause> {
  ...
  QueryBuilder<Location, Location, QAfterWhereClause> createdAtEqualTo(
      DateTime createdAt) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterWhereClause> createdAtNotEqualTo(
      DateTime createdAt) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Location, Location, QAfterWhereClause> createdAtGreaterThan(
    DateTime createdAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterWhereClause> createdAtLessThan(
    DateTime createdAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterWhereClause> createdAtBetween(
...
extension LocationQueryFilter
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> isDepartureEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isDeparture',
        value: value,
      ));
    });
  }
...
extension LocationQuerySortBy on QueryBuilder<Location, Location, QSortBy> {
  QueryBuilder<Location, Location, QAfterSortBy> sortByAddress() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'address', Sort.asc);
    });
  }

  QueryBuilder<Location, Location, QAfterSortBy> sortByAddressDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterSortBy> sortByIsDeparture() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDeparture', Sort.asc);
    });
  }

  QueryBuilder<Location, Location, QAfterSortBy> sortByIsDepartureDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDeparture', Sort.desc);
    });
  }
...
extension LocationQuerySortThenBy
  ...
  QueryBuilder<Location, Location, QAfterSortBy> thenByAddress() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'address', Sort.asc);
    });
  }

  QueryBuilder<Location, Location, QAfterSortBy> thenByAddressDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'address', Sort.desc);
    });
  }
  ...
  QueryBuilder<Location, Location, QAfterSortBy> thenByIsDeparture() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDeparture', Sort.asc);
    });
  }

  QueryBuilder<Location, Location, QAfterSortBy> thenByIsDepartureDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDeparture', Sort.desc);
    });
  }
...
extension LocationQueryWhereDistinct
  ...
  QueryBuilder<Location, Location, QDistinct> distinctByAddress(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QDistinct> distinctByIsDeparture() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isDeparture');
    });
  }
...
extension LocationQueryProperty
  ...
  QueryBuilder<Location, String, QQueryOperations> addressProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, bool, QQueryOperations> isDepartureProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isDeparture');
    });
  }
